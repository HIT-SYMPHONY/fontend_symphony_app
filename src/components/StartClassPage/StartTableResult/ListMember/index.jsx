...
import Classroom from "../../StartMyClass/Classroom";
import icon from "./../../../../assets/img/Ellipse.png";
import logo from "./../../../../assets/img/logo.png";
import Frame from "../../StartMyClass/Frame";
import TableResult from "../TableResult";
import TableCompetition from "../TableCompetition";
import Logout from "../../../Logout";
import Account from "../../../StartAccount/Account";
import "./style.scss";
      ...
      <div className="homepage">
        ...
        <div className="homepage__main">
          <div className="homepage__main__search">
            ...
            {sub ? (
              <TableResult onSetSub={setSub} />
            ) : (
              <TableCompetition onSetSub={setSub} />
            )}
          </div>
        </div>
